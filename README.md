<div align="center">
  <img alt="Bolt Abacus Logo" src="/public/logo.png" width="200" style="margin-bottom: 20px;" />f
...
4. **CRITICAL STEP - Root Directory**: Because the code is sitting inside a folder in your GitHub repository, you MUST click "Edit" next to the **Root Directory** field and enter:
   `Downloads/bolt-abacus_landing_page`
5. Vercel will auto-detect the framework (Vite/React). Leave the default build settings (`npm run build`).
6. Click **"Deploy"**.
