...
export const Problem: React.FC = () => {
  ...
  return (
    <section id="problem" className="pt-8 pb-24 bg-black relative overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        {/* Unique Confident Statement */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-50px" }}
          transition={{ duration: 1, ease: [0.16, 1, 0.3, 1] }}
          className="mt-24 mb-10 w-full max-w-4xl mx-auto relative px-4"
        >
          ...
          <div className="relative z-10 flex flex-col md:flex-row items-stretch gap-0 border border-gold-500/10 rounded-2xl overflow-hidden bg-gradient-to-br from-neutral-900/50 to-black/80 backdrop-blur-xl shadow-2xl">

            {/* Left Side: The Problem (Dark & Stark) */}
            <div className="w-full md:w-[55%] p-6 md:p-10 relative">
            ...
            {/* Right Side: The Solution (Bright & Gold) */}
            <div className="w-full md:w-[45%] p-6 md:p-10 relative flex items-center bg-gradient-to-br from-gold-900/30 to-black overflow-hidden group">
